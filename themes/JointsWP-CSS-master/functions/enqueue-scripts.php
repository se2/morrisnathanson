...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_script( 'site-slick-js', get_template_directory_uri() . '/assets/scripts/slick.min.js', array( 'jquery' ), filemtime(get_template_directory() . '/assets/scripts'), true );
    ...
    // Slick style
    wp_enqueue_style( 'site-slick', get_template_directory_uri() . '/assets/styles/slick.css', array(), filemtime(get_template_directory() . '/assets/styles'), 'all' );
    wp_enqueue_style( 'site-slick-theme', get_template_directory_uri() . '/assets/styles/slick-theme.css', array(), filemtime(get_template_directory() . '/assets/styles'), 'all' );
    ...
    // Icomoon
    wp_enqueue_style( 'site-icomoon', get_template_directory_uri() . '/assets/styles/icomoon.css', array(), filemtime(get_template_directory() . '/assets/styles'), 'all' );
